...
SWIFT_CLASS("_TtC14SidebarOverlay25SOContainerViewController")
@interface SOContainerViewController : UIViewController <UIGestureRecognizerDelegate>
...
/// 
/// </code>
@property (nonatomic, strong) UIViewController * __nullable topViewController;
...
///
/// Usually you have to set it only once, when you prepare an instance of <code>SOContainerViewController
/// </code> to be presented.
@property (nonatomic, strong) UIViewController * __nullable leftViewController;
@property (nonatomic) BOOL isLeftViewControllerPresented;
...
@interface UIViewController (SWIFT_EXTENSION(SidebarOverlay))

/// Use this computed property to access the container view controller from any view controller.
///
/// \returns  An instance of <code>SOContainerViewController
/// </code> that holds current view controller or <code>nil
/// </code> if there is no container view controller.
@property (nonatomic, readonly, strong) SOContainerViewController * __nullable so_containerViewController;
@end
